import { FileDown, Target, ShieldAlert, Sparkles, BrainCircuit } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#09090b] text-zinc-100 p-8 pt-24 font-sans relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-8 relative z-10">
        ...
        <div className="flex justify-between items-end border-b border-zinc-800 pb-6">
          ...
          <button className="bg-zinc-100 text-zinc-950 px-6 py-2.5 rounded-full font-semibold hover:bg-zinc-300 transition-all flex items-center gap-2.5">
            <FileDown size={18} /> Upload Latest Resume
          </button>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white/5 border border-white/10 backdrop-blur-xl p-8 rounded-3xl relative overflow-hidden">
                ...
                <div className="text-7xl font-bold mt-2">81<span className="text-2xl text-zinc-600">/100</span></div>
                <p className="text-sm text-zinc-400 mt-5">Your resume is highly parsable and well-structured.</p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 backdrop-blur-xl p-8 rounded-3xl">
                ...
                <div className="mt-5 flex flex-wrap gap-2.5">
                  {["Next.js", "FastAPI", "React", "Python", "Tailwind", "Gemini API"].map(skill => (
                    <span key={skill} className="px-4 py-1.5 rounded-full bg-violet-500/10 text-violet-400 text-xs border border-violet-500/20 font-medium">
                      {skill}
                    </span>
                  ))}
                </div>
            ...
            <div className="bg-white/5 border border-white/10 backdrop-blur-xl p-8 rounded-3xl min-h-[300px] flex items-center justify-center group relative">
            ...
            <div className="bg-white/5 border border-white/10 backdrop-blur-xl p-7 rounded-3xl">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-zinc-800/40 rounded-xl border border-zinc-700 text-xs text-zinc-400">
                  ...
                  Convert &quot;Managed hospital ERP&quot; to &quot;Optimized ERP response time by 40% using FastAPI dependency injection.&quot;
                </div>
                <div className="p-4 bg-zinc-800/40 rounded-xl border border-zinc-700 text-xs text-zinc-400">
